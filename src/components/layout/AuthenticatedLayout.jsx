...
const AuthenticatedLayout = () => {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-green-50/30'}`}
    >
      {/* Header */}
      ...
      <div className="flex flex-1 lg:h-[calc(100vh-4rem)]">
        ...
        {/* Main Content Area */}
        <main
          className={`flex-1 overflow-y-auto ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-transparent'} lg:h-[calc(100vh-4rem)]`}
        >
