...
const LightSensorChart = React.memo(() => {
  ...
  const chartData = useMemo(() => {
    return sensorData
      ...
      .map((item) => ({
        ...
        light: parseInt(item.light_level) || 0,
      }))
      .filter((item) => item.light >= 0); // Filter out negative values
  }, [sensorData]);
      ...
      <div className="h-72 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            aria-label="Retry loading light sensor data"
          >
            Retry
          </button>
        </div>
    ...
    return (
      <div className="h-72 flex items-center justify-center">
        <div className="text-center">
          ...
          >
            No light sensor data available
          </p>
          <p
  ...
  return (
    <div
      className="h-72"
      role="region"
      aria-label="Light sensor trends chart"
    >
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis
            ...
            domain={[0, 4095]} // Light sensor range is 0-4095
            stroke={isDark ? '#374151' : '#e5e7eb'}
          />
          <Tooltip
